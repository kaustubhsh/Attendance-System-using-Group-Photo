...
def face_locations(img, number_of_times_to_upsample=0, model="cnn"):
    """
    Returns an array of bounding boxes of human faces in a image
...
def _raw_face_locations_batched(images, number_of_times_to_upsample=0, batch_size=128):
    """
...
def batch_face_locations(images, number_of_times_to_upsample=0, batch_size=128):
    """
